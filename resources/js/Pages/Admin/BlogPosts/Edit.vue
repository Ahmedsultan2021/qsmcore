...
const form = useForm({
    ...
    featured_image: props.blogPost.featured_image || "",
    is_published: props.blogPost.is_published || false,
    published_at: props.blogPost.published_at ? new Date(props.blogPost.published_at).toISOString().slice(0, 16) : "",
});

const submit = () => {
    form.put(route("blog-posts.update", props.blogPost.id));
};
</script>
...
<template>
    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Blog Post</h1>
