...
<template>
    ...
    <div class="p-6">
        <div class="mb-6">
            <Link
                :href="route('employees.index', company_id ? { company_id } : {})"
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Employee</h1>
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <option v-for="company in companies" :key="company.id" :value="company.id">
                            {{ company.sector.industry.name }} - {{ company.sector.name }} - {{ company.name }}
                        </option>
                    </select>
                    <div v-if="form.errors.company_id" class="mt-1 text-sm text-red-600">{{ form.errors.company_id }}</div>
                </div>
