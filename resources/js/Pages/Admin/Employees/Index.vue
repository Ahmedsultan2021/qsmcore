...
const filteredCompanies = computed(() => {
    if (filterForm.sector_id) {
        return (props.companies || []).filter(company => company.sector_id == filterForm.sector_id);
    }
    if (filterForm.industry_id) {
        return (props.companies || []).filter(company => company.sector?.industry_id == filterForm.industry_id);
    }
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                    ...
                    <select
                        ...
                        @change="filterForm.sector_id = ''; filterForm.company_id = ''; applyFilters()"
                ...
                <div>
                    ...
                    <select
                        ...
                        @change="filterForm.company_id = ''; applyFilters()"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    >
