...
const submit = () => {
    form.post(route("help-documents.update", props.document.id), {
        forceFormData: true,
    });
};
</script>
...
<template>
    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Help Document</h1>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600">
                    <div class="text-sm text-gray-700 dark:text-gray-200">
                        ...
                        <a :href="document.file_url" target="_blank" class="text-blue-600 hover:underline ml-1">
                ...
                <div class="mb-4">
                    ...
                    />
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Leave empty to keep the current file.</p>
