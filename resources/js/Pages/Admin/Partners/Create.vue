...
const submit = () => form.post(route('partners.store'), { forceFormData: true });
</script>
...
<template>
    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 max-w-2xl">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Add Partner</h1>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <button v-if="preview" type="button" @click="preview = null; form.logo = null" class="text-xs text-red-600 hover:text-red-800 mt-2">Remove</button>
                    </div>
