...
const submit = () => {
    form.post(route("companies.audits.update", props.audit.id), {
        forceFormData: true,
    });
};
...
<template>
    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Audit</h1>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    ...
                    <div v-if="audit.attached_file" class="mb-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Current file</p>
                    </div>
                    <input
                        id="attached_file"
                ...
                <div class="flex justify-end gap-3">
                    ...
                    >
                        {{ form.processing ? "Updating..." : "Update Audit" }}
                    </button>
                </div>
            </form>
        </div>
